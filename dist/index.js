(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["re-tabs"] = factory();
	else
		root["re-tabs"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TabPane = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var propTypes = {
	    activeKey: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]),
	    children: _react.PropTypes.node.isRequired,
	    navs: _react.PropTypes.arrayOf(_react.PropTypes.shape({
	        value: _react2.default.PropTypes.string,
	        key: _react2.default.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string])
	    })).isRequired,
	...
	var Tabs = function (_React$Component) {
	    ...
	    _createClass(Tabs, [{
	        ...
	        value: function render() {
	            ...
	            var activePositon = 0;
	            var contents = navs.map(function (item, index) {
	                var cls = '';
	                ...
	                return _react2.default.createElement(
	                    'li',
	                    { key: item.key, className: cls, onClick: function onClick() {
	            ...
	            var inkBarPosition = 'translate3d(' + 100 * activePositon + '%, 0px, 0px)';

	            var panes = _react2.default.Children.map(children, function (child) {
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'tab-pane scroller' },
	                    child
	                );
	            });
	            var tabPanesPosition = 'translate3d(' + -100 * activePositon + '%, 0px, 0px)';
	            return _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        { className: 'tab-nav' },
	                        contents,
	                        _react2.default.createElement('div', { className: 'tab-ink-bar', style: { transform: inkBarPosition, WebkitTransform: inkBarPosition } })
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'tab-panes', style: { transform: tabPanesPosition, WebkitTransform: tabPanesPosition } },
	                    panes
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".tabs-wrapper {\n  width: 100%;\n  overflow-x: hidden;\n  -webkit-tap-highlight-color: rgba(0, 0, 0, 0);\n}\n.tabs-wrapper a {\n  text-decoration: none;\n}\n.tabs-wrapper ul,\n.tabs-wrapper li {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n.tabs-wrapper .tabs-bar {\n  margin: 0 4%;\n  height: 44px;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.tabs-wrapper .tabs-bar .tab-nav {\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: start;\n  -webkit-justify-content: flex-start;\n      -ms-flex-pack: start;\n          justify-content: flex-start;\n  -webkit-box-align: center;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center;\n  position: relative;\n  width: 100%;\n}\n.tabs-wrapper .tabs-bar .tab-nav li {\n  width: 25%;\n  color: #999999;\n  text-align: center;\n  height: 16px;\n  line-height: 16px;\n  font-size: 14px;\n  cursor: pointer;\n  -webkit-tap-highlight-color: rgba(0, 0, 0, 0);\n}\n.tabs-wrapper .tabs-bar .tab-nav li.active {\n  color: #fb4a46;\n}\n.tabs-wrapper .tabs-bar .tab-nav .tab-ink-bar {\n  border-bottom: 1px solid #fb4a46;\n  width: 25%;\n  position: absolute;\n  left: 0;\n  top: 20px;\n  margin: auto;\n  -webkit-transform: translate3d(0px, 0px, 0px);\n          transform: translate3d(0px, 0px, 0px);\n  -webkit-transition: -webkit-transform 0.3s cubic-bezier(0.35, 0, 0.25, 1);\n  transition: -webkit-transform 0.3s cubic-bezier(0.35, 0, 0.25, 1);\n  transition: transform 0.3s cubic-bezier(0.35, 0, 0.25, 1);\n  transition: transform 0.3s cubic-bezier(0.35, 0, 0.25, 1), -webkit-transform 0.3s cubic-bezier(0.35, 0, 0.25, 1);\n}\n.tabs-wrapper .tab-panes {\n  width: 100%;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-flex-wrap: nowrap;\n      -ms-flex-wrap: nowrap;\n          flex-wrap: nowrap;\n  -webkit-transform: translate3d(0px, 0px, 0px);\n          transform: translate3d(0px, 0px, 0px);\n  -webkit-transition: -webkit-transform 0.3s cubic-bezier(0.35, 0, 0.25, 1);\n  transition: -webkit-transform 0.3s cubic-bezier(0.35, 0, 0.25, 1);\n  transition: transform 0.3s cubic-bezier(0.35, 0, 0.25, 1);\n  transition: transform 0.3s cubic-bezier(0.35, 0, 0.25, 1), -webkit-transform 0.3s cubic-bezier(0.35, 0, 0.25, 1);\n}\n.tabs-wrapper .tab-panes .tab-pane {\n  -webkit-box-flex: 0;\n  -webkit-flex: none;\n      -ms-flex: none;\n          flex: none;\n  width: 100%;\n  overflow-y: scroll;\n  -webkit-overflow-scrolling: touch;\n}\n", ""]);
